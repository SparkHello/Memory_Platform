...
GATEWAY_CONFIG_SCHEMA_VERSION = 2
GATEWAY_CONFIG_LOADABLE_SCHEMA_VERSIONS = (1, GATEWAY_CONFIG_SCHEMA_VERSION)
...
class GatewayConfig(StrictModel):
    ...
    schema_version: Literal[2] = GATEWAY_CONFIG_SCHEMA_VERSION
    ...
    def migrate_v1(cls, value: Any) -> Any:
        ...
        payload["schema_version"] = GATEWAY_CONFIG_SCHEMA_VERSION
...
__all__ = [
    ...
    "GATEWAY_CONFIG_LOADABLE_SCHEMA_VERSIONS",
    "GATEWAY_CONFIG_SCHEMA_VERSION",
    "ID_PATTERN",
    "REQUEST_TRANSFORM_PROTECTED_FIELDS",
    "AdapterName",
    "AuthConfig",
    "BillingPlan",
    "BillingPlanType",
